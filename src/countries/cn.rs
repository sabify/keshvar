...
pub mod consts {
    ...
    pub const VEHICLE_REGISTRATION_CODE: Option<&str> = Some("CHN*");
            ...
            [
                ...
                (
                    ...
                    Subdivision{
                        ...
                        subdivision_type: SubdivisionType::Province,
                        #[cfg(feature = "translations")]
                        translations: HashMap::from([("af", "Hainan"), ("am", "ሃይናን"), ("ar", "هاينان"), ("az", "Haynan"), ("be", "Правінцыя Хайнань"), ("bg", "Хайнан"), ("bn", "হ\u{9be}ইন\u{9be}ন"), ("ca", "Hainan"), ("ceb", "Hainan Sheng"), ("cs", "Chaj-nan"), ("cy", "Hainan"), ("da", "Hainan"), ("de", "Hainan"), ("el", "Χαϊνάν"), ("en", "Hainan"), ("es", "Hainan"), ("et", "Hainan"), ("eu", "Hainan"), ("fa", "هاینان"), ("fi", "Hainan"), ("fr", "Hainan"), ("ga", "Hainan"), ("gl", "Hainan"), ("gu", "હ\u{ac8}નન"), ("he", "האינאן"), ("hi", "हाइनान"), ("hr", "Hainan"), ("hu", "Hajnan"), ("id", "Hainan"), ("is", "Hainan"), ("it", "Hainan"), ("ja", "海南省"), ("ka", "ხაინანი"), ("kk", "Хайнань аралы"), ("kn", "ಹ\u{cc8}ನಾನ\u{ccd}"), ("ko", "하이난 성"), ("ky", "Хайнань"), ("lt", "Hainanas"), ("lv", "Hainaņa"), ("mk", "Хајнан"), ("mn", "Хайнань"), ("mr", "हाइनान"), ("ms", "Hainan"), ("nb", "Hainan"), ("nl", "Hainan"), ("no", "Hainan"), ("pa", "ਹਾਈਨਾਨ"), ("pl", "Hajnan"), ("pt", "Hainan"), ("ro", "Hainan"), ("ru", "Хайнань"), ("sd", "ھائنان صوبو"), ("si", "හය\u{dd2}නන\u{dca}"), ("sk", "Chaj-nan"), ("sr", "Хајнан"), ("sr_Latn", "Hajnan"), ("sv", "Hainan"), ("sw", "Hainan"), ("ta", "ஆய\u{bcd}ன\u{bbe}ன\u{bcd}"), ("te", "హ\u{c48}నన\u{c4d}"), ("th", "มณฑลไหหลำ"), ("tr", "Hainan"), ("uk", "Хайнань"), ("ur", "ہائنان"), ("uz", "Xaynan"), ("vi", "Hải Nam"), ("yue", "海南"), ("yue_Hans", "海南"), ("zh", "海南省")]),
...
pub fn new() -> Country {
    Country {
        ...
        maybe_vehicle_registration_code: Some("CHN*"),
        number: "156",
        postal_code: true,
