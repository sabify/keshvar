...
pub mod consts {
    ...
    pub const TRANSLATIONS: &[(&str, &str)] = &[
        ...
        ("kn", "ಫಾಕ\u{ccd}\u{200d}ಲ\u{ccd}ಯಾಂಡ\u{ccd} ದ\u{ccd}ವ\u{cc0}ಪಗಳು(ಮಾಲ\u{ccd}ವ\u{cbf}ನಾಸ\u{ccd})"),
        ("ko", "포클랜드 제도 (말비나스)"),
