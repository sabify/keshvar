...
pub mod consts {
    ...
    pub const TRANSLATIONS: &[(&str, &str)] = &[
        ...
        (
            "kn",
            "ಕ\u{ccb}ಕ\u{ccb}ಸ\u{ccd}(ಕ\u{cc0}ಲ\u{cbf}ಂಗ\u{ccd})ದ\u{ccd}ವ\u{cc0}ಪಗಳು",
        ),
        ("ko", "코코스 제도"),
