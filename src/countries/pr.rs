...
pub mod consts {
    ...
    pub const VEHICLE_REGISTRATION_CODE: Option<&str> = Some("PRI");
    ...
    pub const POPULATION: Option<u64> = Some(3221789);
    #[cfg(feature = "emojis")]
    pub const EMOJI: &str = "🇵🇷";
    ...
    pub const TRANSLATIONS: &[(&str, &str)] = &[
        ...
        ("kn", "ಪ\u{ccb}ರ\u{ccd}ಟ\u{ccb}ರ\u{cbf}ಕಾ"),
        ("ko", "푸에르토리코"),
        ("ku", "Porto Rîko"),
        ("kv", "Puerto Rico"),
        ("kw", "Puerto Rico"),
...
pub fn new() -> Country {
    Country {
        ...
        maybe_gec: Some(GEC::RQ),
        #[cfg(feature = "geo")]
        geo: geo::new(),
        international_prefix: "011",
        maybe_ioc: Some(IOC::PUR),
        ...
        national_prefix: "1",
        maybe_nationality: Some("Puerto Rican"),
        maybe_vehicle_registration_code: Some("PRI"),
        number: "630",
        postal_code: true,
