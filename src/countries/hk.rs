...
pub mod consts {
    ...
    pub const VEHICLE_REGISTRATION_CODE: Option<&str> = Some("HK");
    ...
    pub const POPULATION: Option<u64> = Some(7346100);
    #[cfg(feature = "emojis")]
    pub const EMOJI: &str = "🇭🇰";
...
pub fn new() -> Country {
    Country {
        ...
        maybe_gec: Some(GEC::HK),
        #[cfg(feature = "geo")]
        geo: geo::new(),
        international_prefix: "001",
        maybe_ioc: Some(IOC::HKG),
        ...
        maybe_nationality: Some("Hong Kongese"),
        maybe_vehicle_registration_code: Some("HK"),
        number: "344",
        postal_code: false,
